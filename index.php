...
$certificate_path = "certs/Web-push-cert.p12";     // Change this to the path where your certificate is located
$certificate_password = "qwerty@1234"; // Change this to the certificate's import password
...
function create_signature($package_dir, $cert_path, $cert_password) {
    ...
    openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "D:\patch\push-notification-learning\ios_push_notifications\certs\apns-dev-cert.pem");
